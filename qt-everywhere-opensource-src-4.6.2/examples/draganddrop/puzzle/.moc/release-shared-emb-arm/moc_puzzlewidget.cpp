...
**
** Created: Mon Feb 13 23:08:39 2012
...
static const char qt_meta_stringdata_PuzzleWidget[] = {
    "PuzzleWidget\0\0puzzleCompleted()\0"
};

const QMetaObject PuzzleWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PuzzleWidget,
      qt_meta_data_PuzzleWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PuzzleWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PuzzleWidget))
