...
**
** Created: Mon Feb 13 23:19:19 2012
...
const QMetaObject InformationWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_InformationWindow,
      qt_meta_data_InformationWindow, 0 }
};
...
int InformationWindow::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: imageChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 1: revert(); break;
        case 2: submit(); break;
        case 3: enableButtons((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: enableButtons(); break;
        default: ;
        }
        _id -= 5;
    }
