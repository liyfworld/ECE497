...
public:
    ...
    void setupUi(QWidget *MyInputPanelForm)
    {
        ...
        MyInputPanelForm->resize(167, 233);
        verticalLayout = new QVBoxLayout(MyInputPanelForm);
        ...
        QObject::connect(closeButton, SIGNAL(clicked()), MyInputPanelForm, SLOT(hide()));
    ...
    void retranslateUi(QWidget *MyInputPanelForm)
    {
        ...
        closeButton->setText(QApplication::translate("MyInputPanelForm", "Close", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
