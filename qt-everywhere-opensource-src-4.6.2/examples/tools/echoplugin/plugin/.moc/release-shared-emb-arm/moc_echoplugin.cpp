...
**
** Created: Mon Feb 13 23:20:59 2012
...
static const char qt_meta_stringdata_EchoPlugin[] = {
    "EchoPlugin\0"
};

const QMetaObject EchoPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_EchoPlugin,
      qt_meta_data_EchoPlugin, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EchoPlugin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EchoPlugin))
    ...
    if (!strcmp(_clname, "com.trolltech.Plugin.EchoInterface/1.0"))
        return static_cast< EchoInterface*>(const_cast< EchoPlugin*>(this));
