...
**
** Created: Mon Feb 13 23:21:29 2012
...
static const char qt_meta_stringdata_ExtraFiltersPlugin[] = {
    "ExtraFiltersPlugin\0"
};

const QMetaObject ExtraFiltersPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ExtraFiltersPlugin,
      qt_meta_data_ExtraFiltersPlugin, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ExtraFiltersPlugin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ExtraFiltersPlugin))
