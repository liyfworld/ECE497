...
**
** Created: Mon Feb 13 23:14:08 2012
...
static const char qt_meta_stringdata_ArrowPad[] = {
    "ArrowPad\0"
};

const QMetaObject ArrowPad::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ArrowPad,
      qt_meta_data_ArrowPad, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ArrowPad::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ArrowPad))
        return static_cast<void*>(const_cast< ArrowPad*>(this));
