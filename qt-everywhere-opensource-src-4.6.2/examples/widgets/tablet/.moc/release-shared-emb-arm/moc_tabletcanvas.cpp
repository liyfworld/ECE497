...
static const char qt_meta_stringdata_TabletCanvas[] = {
    "TabletCanvas\0"
};

const QMetaObject TabletCanvas::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TabletCanvas,
      qt_meta_data_TabletCanvas, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TabletCanvas::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TabletCanvas))
        return static_cast<void*>(const_cast< TabletCanvas*>(this));
