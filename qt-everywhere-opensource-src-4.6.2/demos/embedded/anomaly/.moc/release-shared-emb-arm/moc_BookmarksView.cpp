...
**
** Created: Mon Feb 13 23:34:23 2012
...
static const char qt_meta_stringdata_BookmarksView[] = {
    "BookmarksView\0\0url\0urlSelected(QUrl)\0"
    "item\0activate(QListWidgetItem*)\0"
};

const QMetaObject BookmarksView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BookmarksView,
      qt_meta_data_BookmarksView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BookmarksView::getStaticMetaObject() { return staticMetaObject; }
...
int BookmarksView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: urlSelected((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        case 1: activate((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void BookmarksView::urlSelected(const QUrl & _t1)
{
