...
int EmbeddedDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: layoutDirectionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: spacingChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: fontChanged((*reinterpret_cast< const QFont(*)>(_a[1]))); break;
        case 3: styleChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 4;
    }
