...
**
** Created: Mon Feb 13 21:54:42 2012
...
static const uint qt_meta_data_QNetworkReply[] = {
 ...
 // enum data: key, value
     ...
     650, uint(QNetworkReply::ContentReSendError),
     669, uint(QNetworkReply::UnknownContentError),
     689, uint(QNetworkReply::ProtocolUnknownError),
     710, uint(QNetworkReply::ProtocolInvalidOperationError),
     740, uint(QNetworkReply::ProtocolFailure),
